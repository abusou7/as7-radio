if IsDuplicityVersion() then -- Check if server sided
    ...
    elseif Scully.Framework == 'scully_core' then
        ...
        RegisterNetEvent('as7_radio:getPermissions', function()
            ...
            TriggerClientEvent('as7_radio:sendPermissions', _source, permissions)
        end)
    end
else
    local PlayerData = {}
    if Scully.Framework == 'qb-core' then
        ...
        RegisterNetEvent('QBCore:Client:OnPlayerUnload', function()
            PlayerData = {}
            TriggerEvent('as7_radio:leaveChannel', true)
        end)
    ...
    elseif Scully.Framework == 'scully_core' then
        ...
        CreateThread(function()
            TriggerServerEvent('as7_radio:getPermissions')
        end)

        RegisterNetEvent('as7_radio:sendPermissions', function(permissions)
